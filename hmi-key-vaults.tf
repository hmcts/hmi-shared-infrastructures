locals {
  ...
  "crime-client-host", "health-check-url", "hmi-emulator-host", "hmi-emulator-ctx", "cft-OAuth-url", "hmi-crime-cert-password", "hmi-crime-cert-base-64", "cft-idam-client-secret"]
